...
{
    /**
     * Listar todos os itens de menu permitidos para o nível informado
     *
     * @param int $nivelId Nivel do usuário enviado pelo frontend
     */
    public static function listar(int $nivelId): void
    {
        try {
            $itens = MenuItemDao::listarPorNivel($nivelId);
